...
def connect_to_associate(associate):
    if clients:
        client_to_connect = clients.pop(0)  # time compleixty -> list's pop() -> O(n) -> bad case
...
# # output: 
# 100 list: 1.050000e-05 | deque: 4.200000e-06
#      1000 list: 8.070000e-05 | deque: 4.110000e-05
#     10000 list: 7.743850e-02 | deque: 3.982000e-04
#    100000 list: 7.555413e+00 | deque: 3.895600e-03
...
def connect_to_associate(associate):
    if clients:
        ...
        print(f"out: Removing {client_to_connect}, connecting to {associate}.")
    
    else:
        print(f"No more clients are waiting.")
