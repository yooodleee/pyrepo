...
class TestTaskCreation(unittest.TestCase):
    def setUp(self):        
        ...
        self.task_dict = task_to_compare.__dict__       # Task("Laundry", 3).__dict__

    def test_create_task(self):
        task_text = "Laundry,3"
        created_task = Task.create_task(task_text)
    ...
    def test_create_task_from_dict(self):
        ...
        created_task = Task.create_task_from_dict(task_data)
        self.assertEqual(created_task.__dict__, self.task_dict)
